...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      isScrolled 
        ? 'bg-secondary/95 backdrop-blur-xl border-b border-white/20 shadow-lg shadow-secondary/20' 
        : 'bg-transparent'
    }`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        <div className={`lg:hidden absolute top-full left-0 right-0 bg-secondary/95 backdrop-blur-xl border-t border-white/20 transition-all duration-500 ${
